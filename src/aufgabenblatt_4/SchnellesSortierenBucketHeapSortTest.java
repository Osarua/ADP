...
public class SchnellesSortierenBucketHeapSortTest {
	...
	public void testSchnellesSortierenNk1() {
		...
		SchnellesSortierenBucketHeapSort<Integer> sS = new SchnellesSortierenBucketHeapSort<>();
		int max = 8000;
		int min = 7000;
...
public void testSchnellesSortierenNk3() {
	...
	public void testSchnellesSortierenNk5() {
		...
		// }
		// }
		// assertEquals("Sollte true sein, wenn Array korrekt sortiert ist",
		// korrektSortiert, true);
	}
