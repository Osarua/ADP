...
public class EinfachVerketteteListeTest {
	...
	public void testKonstruktor() {
		Liste<Integer> aBs = new EinfachVerketteteListe<>();
	...
	public void testEinfuegenNachruecken(){
		Liste<String> aBsString = new EinfachVerketteteListe<>();
	...
	public void testEntfernenMitte(){
		Liste<Character> aBsChar = new EinfachVerketteteListe<>();
	...
	public void testFinde() {
		Liste<Integer> aBsInt = new EinfachVerketteteListe<>();
	...
	public void testEntfernennIndexOutOfBoundsExceptionNeg(){
		Liste<Character> aBsString = new EinfachVerketteteListe<>();
		aBsString.einfuegen('a', 0);
		exception.expect(IndexOutOfBoundsException.class);
		exception.expectMessage("Ungueltiger Index Zugriff: -2");
	...
	public void testListenZusammenfuegen() {
		Liste<Integer> aBs = new EinfachVerketteteListe<>();
		aBs.einfuegen(1, 0);
		Liste<Integer> aBsDiff = new EinfachVerketteteListe<>();
		...
		Liste<Number> aBsNumber = new EinfachVerketteteListe<>();
		Liste<Number> aBsNumber2 = new EinfachVerketteteListe<>();
	...
	public void testGroesseDerListe(){
		Liste<Integer> gDL = new EinfachVerketteteListe<>();
